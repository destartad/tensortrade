...
checkpoint_path = r"C:\Users\xianli\ray_results\PPO_vannila\PPO_TradingEnv_5fd6a_00000_0_2021-03-08_15-10-33\checkpoint_310\checkpoint-310"

myAgent = PPOTrainer.restore(checking_path=checkpoint_path)
...
minute_EURUSD = load_csv(r"C:\Users\xianli\Desktop\Trade\MyProject\tensortrade\data\EURUSD_1minute.csv")
#minute_EURUSD = load_csv('y.csv')
#minute_EURUSD_ta = ta.add_all_ta_features(minute_EURUSD, 'open', 'high', 'low', 'close', 'volume', fillna=True)
...
obs = env.reset()
while not done:
    action = myAgent.compute_action(obs)
